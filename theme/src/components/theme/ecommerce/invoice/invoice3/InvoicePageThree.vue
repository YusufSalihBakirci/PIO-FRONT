    ...
    <table class="table-wrapper table-responsive table-borderless theme-scrollbar">
            ...
            <tr>
                <td>
                    <table class="table-responsive table-borderless"
                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px 0;"><img class="for-dark" src="@/assets/images/logo/logo1.png"
                                        alt="logo" /><img class="for-light" src="@/assets/images/logo/logo-dark.png"
                                        alt="logo" />
                        ...
                        <tbody>
                            <tr style="display:flex; justify-content: space-between; margin:28px 0; align-items: center;">
                                <td> <span style=" font-size: 16px; font-weight: 500; opacity: 0.8; font-weight: 600;">BANK
                                        TRANSFER</span>
                                    <h4 style="font-weight:600; margin: 12px 0 5px 0; font-size: 16px; color:#308e87;">
        ...
        <tr>
            <td> <span style="display: flex; justify-content: end; gap: 15px;"><a
                        ...
                        href="/ecommerce/invoice_3" download="">Download<i class="icon-arrow-right"
