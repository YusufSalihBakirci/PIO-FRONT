    ...
    <div class="svg-wrraper">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            ...
            <g id="freepik--Character--inject-22">
                ...
                <path class="shp7"
                    d="M272.28,242.49a54.33,54.33,0,0,1-12,10.77l6,4.89C272.75,252.36,274.59,246.16,272.28,242.49Z"></path>
                <path class="shp3"
                ...
                <path class="shp3"
                    d="M171,248.93c-3.2,4-5,6.92-3.74,8.41s4.94,1,7.05-3.12C173,249.47,171,248.93,171,248.93Z"></path>
                <path class="shp3"
            ...
            <circle class="shp2" cx="185.31" cy="156" r="10.83" transform="translate(-31.62 48.22) rotate(-13.67)">
            </circle>
            <path class="shp1" d="M176.61,156.65a4.56,4.56,0,1,0,2.39-6A4.56,4.56,0,0,0,176.61,156.65Z"></path>
            <circle class="shp2" cx="241.1" cy="132.09" r="10.83" transform="translate(28.89 306.87) rotate(-68.19)">
            </circle>
            ...
            <path class="shp3" d="M131.72,180.23c-8.11,3.81-14,11.91-15.47,21.5,7.16-8.74,15.51-6.17,15.51-6.17Z">
            </path>
            <path class="shp3" d="M132.55,203.86A21.62,21.62,0,0,0,134,224c-.08-8.6,6.06-11.16,6.06-11.16Z"></path>
            <path class="shp3" d="M132.08,190.66c-8.17,6.1-12.85,16.47-12.36,27.51,6-11.39,15.9-10.42,15.9-10.42Z">
            </path>
            ...
            <path class="shp3" d="M303.32,117.3c10.05-1.71,20.78,2.06,28.44,10-12.38-3.51-18.51,4.32-18.51,4.32Z">
            </path>
        ...
        <g id="freepik--ball-of-yarn--inject-22">
            <circle class="shp3" cx="202.29" cy="394.69" r="22.97" transform="translate(-224.74 274.91) rotate(-47.2)">
            </circle>
            <path class="shp3"
