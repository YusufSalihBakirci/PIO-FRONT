<template>
    <div class="svg-wrraper">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            ...
            <path class="shp2" d="M239.71,273.32s-9.9.63-9.9-2.36c0-1.38,7.56-6,10.29-6S239.71,273.32,239.71,273.32Z">
            </path>
        ...
        <g id="freepik--Crumbs--inject-23">
            ...
            <path class="shp6" d="M257.1,428.8c.19-1.59,3.29-1.13,3.78-.27s-1.3,2.54-2.11,1.84S257,429.39,257.1,428.8Z">
            </path>
            <path class="shp5" d="M257.1,428.8c.19-1.59,3.29-1.13,3.78-.27s-1.3,2.54-2.11,1.84S257,429.39,257.1,428.8Z">
            </path>
            <path class="shp6"
...
<div class="col-md-8 offset-md-2">
    ...
    <p class="sub-content">The page you are attempting to reach is currently not available. This may be because the page
        does not exist or has been moved.</p><router-link class="btn btn-primary" to="/">BACK TO HOME
        PAGE</router-link>
</div></template>
<style>tspan {
    white-space: pre
