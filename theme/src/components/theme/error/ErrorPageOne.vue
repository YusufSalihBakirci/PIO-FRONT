    ...
    <div class="svg-wrraper">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
            ...
            <g id="freepik--Character--inject-63">
                ...
                <polygon class="shp2" points="241.56 416.24 206.77 416.24 225.21 405.78 240.66 406.38 241.56 416.24">
                </polygon>
                ...
                <polygon class="shp2" points="332.77 416.24 297.98 416.24 316.42 405.78 331.87 406.38 332.77 416.24">
                </polygon>
...
<div class="col-md-8 offset-md-2">
    ...
    <p class="sub-content">The page you are attempting to reach is currently not available. This may be because
        the page does not exist or has been moved.</p><router-link class="btn btn-primary" to="/">BACK TO HOME
        PAGE</router-link>
</div></template>
<style>tspan {
    white-space: pre
