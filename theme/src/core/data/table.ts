...
export const data: table[] = [
    ...
    },
    {
        ...
        language: "Vue",
        credit: "$4580.00",
        borderColor: "border-bottom-primary",
        country: "IRN",
        class: "bg-primary"
    }
]
...
export const hoverable: table2[] = [
    {
        ...
        stage: "Triaged",
        schedule: "0.33",
        bgClass: "bg-light-success font-success me-3",
    ...
    },
    {
        ...
        stage: "Triaged",
        schedule: "0.39",
        bgClass: "bg-light-danger font-danger me-3",
    ...
    },
    {
        ...
        stage: "No Triaged",
        schedule: "3.12",
        bgClass: "bg-light-primary font-primary me-3",
