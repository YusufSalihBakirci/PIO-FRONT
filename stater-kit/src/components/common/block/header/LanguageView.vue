<template>
    <div class="translate_wrapper" :class="active ? 'active' : ''">
        ...
        <ul class="custom-menu profile-menu language-menu py-0 more_lang" :class="active ? 'active' : ''">
            <li class="d-block" v-for="(lang, index) in data" :key="index" @click.prevent="selectLanguage(lang)"><a
                    class="lang" href="#" data-value="English"><i class="flag-icon " :class="lang.icon"></i>
